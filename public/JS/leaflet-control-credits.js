L.controlCredits = function (t) {
    ...
    onAdd: function (t) {
        ...
        i.innerHTML = this.options.image, this.options.width && (i.style.paddingRight = this.options.width + "px"), this.options.height && (i.style.height = this.options.height + "px");
        ...
        return o.target = "_blank", o.href = this.options.link, o.innerHTML = this.options.text, i.link = o, L.DomEvent.addListener(i, "mousedown", L.DomEvent.stopPropagation).addListener(i, "click", L.DomEvent.stopPropagation).addListener(i, "dblclick", L.DomEvent.stopPropagation).addListener(i, "click", function () {
            var t = this.link;
            // if (L.DomUtil.hasClass(t, "leaflet-credits-showlink")) {
            //     L.DomUtil.removeClass(t, "leaflet-credits-showlink")
            //     i.innerHTML = "<strong>Voir plus</strong>"
            // } else {
            //     L.DomUtil.addClass(t, "leaflet-credits-showlink")
            //     i.innerHTML = "<strong>Voir moins</strong>"
            // }
